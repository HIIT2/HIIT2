...
function randomQuote() {
 ...
 var  randomSelect= mQuotes[Math.floor(Math.random()* mQuotes.length)];
...
<script  onclick="randomQuote()">

function myFunction() {

 var geAy = ['“You just can not beat the person who never gives up." - Babe Ruth',
...
'”If something is important enough, even if the odds are stacked against you, you should still do it.” - Elon Musk'
 ...
 var geBe = geAy[Math.floor(Math.random()* geAy.length)];

  document.getElementById("demo").innerHTML = geBe;
